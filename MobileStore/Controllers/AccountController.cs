...
namespace MobileStore.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginModel model)
        {
            ...
            {
                MD5 mD5 = MD5.Create();
                User user = await db.Users.FirstOrDefaultAsync(u => u.Email == model.Email && u.Password == Convert.ToBase64String(mD5.ComputeHash(Convert.FromBase64String(model.Password))));
                if (user != null)
                {
